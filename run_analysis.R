#cleans workspace and sets the working directory
rm(list = ls())
setwd("D:/R")

#downloads dataset and unzip
...
#loads test & train data and selects the needed features
...
#combines test & train data with labels
...
#cleans the label names, then renames merged data with descriptive variable names
